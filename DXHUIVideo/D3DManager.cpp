...
bool CD3DManager::SaveCanvas ( HCANVAS hCanvas, LPCTSTR pFileName, IMAGE_FILEFORMAT FileFormat, RECT *pSrcRect )
{
	if ( m_pDevice == NULL )
	{
...
ID3DVRInterface::HTEXT CD3DManager::CreateOverlayText ( LPCTSTR strText, LOGFONT *logfont )
{
	if ( m_pDevice == NULL )
	{
		_ASSERTE(m_pDevice != NULL) ;
